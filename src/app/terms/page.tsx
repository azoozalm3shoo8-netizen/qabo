  ...
  return (
    <div className="min-h-screen bg-[#F3F4F6] pb-24 dark:bg-slate-900" dir={dir}>
      ...
      <div className="mx-auto max-w-2xl px-4 py-6">
        ...
        <section>
          <h2 className="font-bold text-lg text-gray-900 mb-3 mt-8">المادة 6 مكرر — فترة الإطلاق المجانية</h2>
          <ul className="list-disc space-y-2 pr-5 text-sm leading-relaxed text-gray-700 marker:text-[#1B7F7A]">
            <li>
              تقدّم المنصة فترة إطلاق مجانية يتم الإعلان عنها ومدتها عبر المنصة وإعداداتها (بما فيها تاريخ الانتهاء).
            </li>
            <li>خلال هذه الفترة، لا تُفرض عمولة على البائع ولا رسم حماية على المشتري وفق ما تُعلنه المنصة.</li>
            <li>
              جميع آليات الحماية (تأمين الجدية، ضمان المزايد، فترة الفحص، النزاعات، نقاط الثقة، وبصمة المنتج وسجل
              الإلغاءات) تبقى سارية بالكامل.
            </li>
            <li>
              تحتفظ المنصة بحقها في إنهاء الفترة المجانية في أي وقت مع إشعار مسبق لا يقل عن 14 يوماً حيث ينطبق ذلك.
            </li>
            <li>
              المعاملات التي بدأت خلال الفترة المجانية تُكمَل بشروطها المجانية (من حيث العمولة ورسم الحماية) حتى لو
              انتهت الفترة أثناء تنفيذها.
            </li>
            <li>بعد انتهاء الفترة المجانية، تُطبَّق العمولة والرسوم المبينة في البند (4) أعلاه وفق الشرائح المعتمدة.</li>
          </ul>
        </section>
